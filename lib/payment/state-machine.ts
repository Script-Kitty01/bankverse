...
const SETTLEMENT_STATE_TRANSITIONS: Record<SettlementState, SettlementState[]> =
  {
    NOT_REQUIRED: ["PENDING_RECONCILIATION", "REFUND_PENDING", "RESOLVED"],
    ...
    RECONCILING: ["RESOLVED", "REFUND_PENDING", "COMPENSATED", "ESCALATED"],
    REFUND_PENDING: ["REFUNDED", "ESCALATED"],
    REFUNDED: ["RESOLVED"],
    COMPENSATED: ["RESOLVED"],
    RESOLVED: ["REFUND_PENDING", "RECONCILING"],
